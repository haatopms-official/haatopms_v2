import { Building2, Clock, LayoutGrid, CalendarRange, Shield, Briefcase, ChevronDown, LogOut, Sun, Moon, Timer, UserCog, Users, History, Settings2, UsersRound, BookOpen } from 'lucide-react';
